...
public class KauppaTest {
    ...
    public void kahdenEriTuotteenostoksenPaaytyttyaPankinMetodiaTilisiirtoKutsutaanOikein() {
        ...
        when(varasto.saldo(1)).thenReturn(10);
        when(varasto.haeTuote(1)).thenReturn(new Tuote(1, "maito", 5));
        // määritellään että tuote numero 2 on leipä jonka hinta on 3 ja saldo 13
    ...
    @Test
    public void tyhjanJaLoytyvanTuotteenOstoksenPaaytyttyaPankinMetodiaTilisiirtoKutsutaanOikein() {
        // luodaan ensin mock-oliot
        Pankki pankki = mock(Pankki.class);
        ...
        k.aloitaAsiointi();
        k.lisaaKoriin(1);     // ostetaan tuotetta numero 1 eli maitoa
        k.lisaaKoriin(2);     // yritetään ostaa tuotetta numero 2 eli leipää
        k.tilimaksu("pekka", "12345");
    ...
    public void aloitaAsiointiNollaaEdellisenOstoksenTiedot() {
        ...
        k.aloitaAsiointi();
        k.lisaaKoriin(1);     // ostetaan tuotetta numero 1 eli maitoa
        k.tilimaksu("pätkä", "666-313");

        // sitten suoritetaan varmistus, että pankin metodia tilisiirto on kutsuttu
        verify(pankki).tilisiirto("pätkä", 42, "666-313", "33333-44455", 5);
    }
    ...
    @Test
    public void poistaaTuotteenOstoskoristaOikein() {
        // luodaan ensin mock-oliot
        Pankki pankki = mock(Pankki.class);
